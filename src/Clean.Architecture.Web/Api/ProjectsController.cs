...
/// <summary>
///   A sample API Controller. Consider using API Endpoints (see Endpoints
///   folder) for a more SOLID approach to building APIs https://github.com/ardalis/ApiEndpoints
/// </summary>
