...
public class ItemCompletedEmailNotificationHandler : INotificationHandler<ToDoItemCompletedEvent>
{
    ...
    // In a REAL app you might want to use the Outbox pattern and a
    // command/queue here...
    ...
    // configure a test email server to demo this works https://ardalis.com/configuring-a-local-test-email-server
